...
make_group_summary_from_metab_ident_format <- function(metab_identified_df = NULL){
  ...
  subset_cols <- c("groupId", "mz", "rt", "compound",  "id", "formula", "feature_group",
                   "adduct_type", "isotope_type", "basemass", samples_vec)
